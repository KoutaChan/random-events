...
tellraw @a ["",{"text":"| TNTの雨[第3回] ","color":"red"},{"selector":"@a[tag=tnt_rain]","color":"red"},{"text":" を中心にTNTが落ちる","color":"red"}]
...
schedule function randomevent:randomevent_tick/tnt_rain_3 3s