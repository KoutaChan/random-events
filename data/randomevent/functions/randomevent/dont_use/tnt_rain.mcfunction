...
tellraw @a ["",{"text":"| TNTの雨[第1回] ","color":"red"},{"selector":"@a[tag=tnt_rain]","color":"red"},{"text":" を中心にTNTが落ちる","color":"red"}]
...
schedule function randomevent:randomevent_tick/tnt_rain_1 3s